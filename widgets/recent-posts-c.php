...
class Flymag_Recent_C extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname'   => 'recent_posts_c clearfix',
			'description' => __( 'Recent posts widget Type C - two categories (front page)', 'flymag' ),
		);
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'cat_one' ); ?>"><?php _e( 'Enter the slug for your first category.', 'flymag' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'cat_one' ); ?>"
				   name="<?php echo $this->get_field_name( 'cat_one' ); ?>" type="text" value="<?php echo $cat_one; ?>"
				   size="3"/></p>

		<p>
			<label for="<?php echo $this->get_field_id( 'cat_two' ); ?>"><?php _e( 'Enter the slug for your second category.', 'flymag' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'cat_two' ); ?>"
				   name="<?php echo $this->get_field_name( 'cat_two' ); ?>" type="text" value="<?php echo $cat_two; ?>"
				   size="3"/></p>
